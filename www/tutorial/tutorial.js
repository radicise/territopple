...
const sequence = [
    ...
    {m:[0,2,1],w:true},
    {t:"When a tile has more pieces on it than it has neighbors (corners have two, edges three, centers four), it topples.\nWhen a tile topples, it resets to one piece and adds a piece to each of its neighbors.",h:"#r0c4"},
    {t:"Like this.",m:[0,4,2],h:["#r0c3","#r0c4","#r1c4"]},
...
(async () => {
    ...
    function executeItem(item) {
        if (item.t) {
            ...
            messageArea.scrollBy({"behavior":"smooth","top":50});
        }
        if (item.m) {
